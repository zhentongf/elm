<template>
  <div class="food_container">
    ...
    <section class="sort_container">
      <!-- 分类 -->
      <div class="sort_item" :class="{choose_type: condition == 'food'}">
        <div class="sort_item_container" @click="chooseType('food')">
          <div class="sort_item_border">
            <span :class="{category_title: condition == 'food'}">{{ foodTitle }}</span>
        ...
        <transition name="showlist">
          <section v-show="condition == 'food'" class="sort_detail_type category_container">
            <section class="category_left">
              <ul>
                <li v-for="(item, index) in category" :key="index" class="category_left_li" :class="{category_active: restaurant_category_id == item.id}" @click="selectCategoryName(item.id, index)">
                  <section>
                    <img :src="getImgPath(item.image_url)" alt="image_url" class="category_icon">
                    <span>{{ item.name }}</span>
                  </section>
                  <section>
            ...
            <section class="category_right">
              <ul>
                <!-- v-if="index" 表示忽略第一个index == 0 的元素 -->
                <li v-for="(item, index) in categoryDetail" v-if="index" :key="index" class="category_right_li" @click="getCategoryIds(item.id, item.name)" :class="{category_right_choosed: restaurant_category_ids == item.id}">
                  <span>{{ item.name }}</span>
      ...
      <!-- 排序 -->
      <div class="sort_item" :class="{choose_type: condition == 'sort'}">
        <div class="sort_item_container" @click="chooseType('sort')">
          <div class="sort_item_border">
            <span :class="{category_title: condition == 'sort'}">排序</span>
            <svg width="10" height="10" xmlns="http://www.w3.org/2000/svg" version="1.1" class="sort_icon">
			    			<polygon points="0,3 10,3 5,8"/>
			    		</svg>
          </div>
        ...
        <transition name="showlist">
          <section v-show="condition == 'sort'" class="sort_detail_type">
      ...
      <!-- 筛选 -->
      <div class="sort_item" :class="{choose_type: condition == 'activity'}">
        <div class="sort_item_container" @click="chooseType('activity')">
          <span :class="{category_title: condition == 'activity'}">筛选</span>
          <svg width="10" height="10" xmlns="http://www.w3.org/2000/svg" version="1.1" class="sort_icon">
		    			<polygon points="0,3 10,3 5,8"/>
		    		</svg>
        </div>
      ...
      <transition name="showlist">
        <section v-show="condition == 'activity'" class="sort_detail_type filter_container">
    ...
    <transition name="showcover">
      <div class="back_cover" v-show="condition"></div>
    </transition>
