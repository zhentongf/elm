            ...
            <li class="order_list_li" v-for="item in orderList" :key="item.id">
                ...
                <section class="order_item_right">
                    ...
                    <div class="order_again">
                        <compute-time v-if="item.status_bar.title == '等待支付'" :time="item.time_pass" @timeout="this.initData()"></compute-time>
...
<script>
    ...
    export default {
        ...
        watch: {
            // 页面刷新时，mounted时userInfo还是null，加载完headTop组件才有，所以需要watch
...
<style lang="scss" scoped>
    ...
    .order_list_ul{
        ...
        .order_list_li{
            ...
            .order_item_right{
                flex: 5;
                // overflow: hidden 防止占用flex父级的右padding
                overflow: hidden;
