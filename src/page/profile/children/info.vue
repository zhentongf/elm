    ...
    <div class="rating_page">
        ...
        <section class="profile-info">
            ...
            <section class="info-router" @click="changePhone">
                <section class="headportrait headportraitwo headportraithree">
                    <h2><img src="../../../images/bindphone.png" style="display:inline-block;margin-right:.4rem;" alt="">手机
                    </h2>
                    <div class="headportrait-div">
                        <p>{{ infotel }}</p>
                        <span class="headportrait-div-bottom">
            ...
            <section class="exitlogin" @click="logout">退出登录</section>
        </section>
            ...
            <section class="cover-content " :class="{ 'cover-animate': isEnter, 'cover-animate-leave': isLeave }">
                ...
                <div class="sa-botton">
                    ...
                    <div style="display:inline-block;">
                        <button class="quitlogin" @click="logoutAct">退出登录</button>
                    </div>
                </div>
            </section>
        </section>
